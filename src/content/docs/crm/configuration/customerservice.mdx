...
![imagen](../../../../assets/crm/configuration/customerService/1.png)
...
![imagen](../../../../assets/crm/configuration/customerService/2.png)
...
![imagen](../../../../assets/crm/configuration/customerService/3.png)
...
![imagen](../../../../assets/crm/configuration/customerService/4.png)

El enrutamiento básico de los registros.

![imagen](../../../../assets/crm/configuration/customerService/5.png)

Así cómo la regla de creación y actualización de registros.

![imagen](../../../../assets/crm/configuration/customerService/6.png)

La configuración incluye la definición de perfiles para cada Área de trabajo.

![imagen](../../../../assets/crm/configuration/customerService/7.png)

![imagen](../../../../assets/crm/configuration/customerService/8.png)

y el área de productividad, donde se habilitan características como Copilot y las funcionalidades de IA.

![imagen](../../../../assets/crm/configuration/customerService/9.png)
...
![imagen](../../../../assets/crm/configuration/customerService/15.png)
...
<CardGrid>
  ...
  <Card title="" icon="">
    ![imagen](../../../../assets/crm/configuration/customerService/16.png)
  </Card>
</CardGrid>
...
<CardGrid>
  ...
  <Card title="" icon="">
    ![imagen](../../../../assets/crm/configuration/customerService/17.png)
  </Card>
</CardGrid>
...
La aplicación Customer Service completa el ecosistema con funcionalidades para la gestión de casos, bases de conocimiento y análisis, dirigidas a elevar los niveles de satisfacción del cliente.
 ...
 ![imagen](../../../../assets/crm/configuration/customerService/18.png)
